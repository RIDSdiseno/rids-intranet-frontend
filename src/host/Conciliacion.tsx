                        ...
                        <div className="relative">
                          ...
                          {menuOpenId === r.id && (
                            <div className="absolute right-0 mt-2 w-48 rounded-md border border-slate-200 bg-white shadow-lg">
                              ...
                              {/* Por Conciliar -> mostrar opción Recordatorio */}
                              {r.estado_conciliacion !== 'CONCILIADA' && (() => {
                                let isVencida = false;
