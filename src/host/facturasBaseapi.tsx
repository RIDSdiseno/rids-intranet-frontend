...
const FacturasBaseapi: React.FC = () => {
    ...
    /* =====================================================
       CLIENTE NO PUEDE CONSULTAR COMPRAS
    ===================================================== */
            ...
            async (
                ...
                try {
                    if (
                        ...
                        throw new Error(
                            "Este endpoint de DTE/XML corresponde a documentos emitidos."
                        );
                    }
                    ...
                    if (!folio) {
                        throw new Error(
                            "No se pudo obtener el folio del documento"
                        );
                    }
            ...
            (
                ...
                void (async () => {
                    ...
                    error
                        ...
                        console.error(
                            "Error preparando PDF automático",
                            error
                        );
                    } finally {
                        setPdfPreparando(
    ...
    return (
        <div className="min-h-screen bg-slate-50 px-3 py-4 sm:px-5 lg:px-6">
            <div className="mx-auto max-w-7xl space-y-4 sm:space-y-5">
                            ...
                            {(
                                ...
                                (
                                    ...
                                    <button
                                        ...
                                        className={`rounded-xl px-4 py-2 text-sm font-bold transition ${mainTab ===
                                            tab
                ...
                {toast && (
                    <div
                        className={`rounded-xl border p-4 text-sm ${toast.type ===
                            "success"
                                    ...
                                    ({
                                        ...
                                        >
                                            <div className="flex items-start justify-between gap-3">
                                                ...
                                                <div
                                                    className={`flex h-10 w-10 shrink-0 items-center justify-center rounded-2xl text-sm font-black ${tone}`}
                                                >
                                                    {
                                                        icon
                                                    }
